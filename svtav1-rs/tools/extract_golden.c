...
extern void svt_av1_idct64_new(const int32_t*, int32_t*, int8_t, const int8_t*);
...
int main(void) {
    ...
    { int32_t in[64]; for(int i=0;i<64;i++) in[i]=(i==0)?4525:0; inv("idct64_dc", svt_av1_idct64_new, in, 64); }
